...
# ====================================================================================== Default imports ======================================================================================
import sys, os, time, logging, shutil, tarfile; from rich import console; print = console.Console().print; from backend.core.configRead import Read; read_def = Read().get_default #          |
...
#                                                              |
logging_maxFiles = int(read_def('MaxLogs')) #                  |
max_backups = int(read_def('MaxBackups')) #                    |
#                                                              |
